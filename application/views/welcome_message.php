...
<head>
    ...
    <title>Jkuat Portal</title>
    <!-- BOOTSTRAP CORE STYLE CSS -->
    <link href="<?php echo base_url(); ?>resource/assets/css/bootstrap.css" rel="stylesheet" />
    <!-- FONT AWESOME CSS -->
<link href="<?php echo base_url(); ?>resource/assets/css/font-awesome.min.css" rel="stylesheet" />
     <!-- FLEXSLIDER CSS -->
<link href="<?php echo base_url(); ?>resource/assets/css/flexslider.css" rel="stylesheet" />
    <!-- CUSTOM STYLE CSS -->
    <link href="<?php echo base_url(); ?>resource/assets/css/style.css" rel="stylesheet" />    
  <!-- Google	Fonts -->
...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="<?php echo base_url(); ?>resource/assets/img/logo-jkuat.jpg" alt=""  /></a>
            </div>
    ...
    <div class="container set-pad">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                     ...
                     <img src="<?php echo base_url(); ?>resource/assets/img/faculty/1.jpg"  class="img-rounded" />
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                     <img src="<?php echo base_url(); ?>resource/assets/img/faculty/2.jpg"  class="img-rounded" />
                   <h3 >JANE DEO ALEX</h3>
                 <hr />
               ...
               <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                     <div class="faculty-div">
                     <img src="<?php echo base_url(); ?>resource/assets/img/faculty/3.jpg" class="img-rounded" />
                   <h3 >RUBY DECORSA</h3>
                 <hr />
    ...
    <!-- FACULTY SECTION END-->
      <div id="course-sec" class="container set-pad">
           ...
           <div class="col-lg-6 col-md-6 col-sm-6 " data-scroll-reveal="enter from the bottom after 0.4s" >
                 <img src="<?php echo base_url(); ?>resource/assets/img/building2.jpg" class="img-thumbnail" />
           </div>
 ...
 <div class="container set-pad">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                        <a href="#">  <img src="<?php echo base_url(); ?>resource/assets/img/Social/facebook.png" alt="" /> </a>
                     <a href="#"> <img src="<?php echo base_url(); ?>resource/assets/img/Social/google-plus.png" alt="" /></a>
                     <a href="#"> <img src="<?php echo base_url(); ?>resource/assets/img/Social/twitter.png" alt="" /></a>
                    </div>
                    </div>
    ...
    <script src="<?php echo base_url(); ?>resource/assets/js/bootstrap.js"></script>
    <!--  Flexslider Scripts --> 
         <script src="<?php echo base_url(); ?>resource/assets/js/jquery.flexslider.js"></script>
     <!--  Scrolling Reveal Script -->
    <script src="<?php echo base_url(); ?>resource/assets/js/scrollReveal.js"></script>
    <!--  Scroll Scripts --> 
    <script src="<?php echo base_url(); ?>resource/assets/js/jquery.easing.min.js"></script>
    <!--  Custom Scripts --> 
